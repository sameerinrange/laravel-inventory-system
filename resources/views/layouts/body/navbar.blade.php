...
<header class="navbar-expand-md">
  ...
  <path d="M7 3l10 0c1.1 0 2 .9 2 2v12c0 1.1 -.9 2 -2 2h-10c-1.1 0 -2 -.9 -2 -2v-12c0-1.1 .9-2 2-2z"/>
  <path d="M9 10l2 3l2 -3"/>
  <path d="M15 10l-2 3l-2 -3"/>
  <path d="M12 18v-4"/>
</svg>
                            </span>
                            <span class="nav-link-title">
  ...
  <path d="M21 21v-2a4 4 0 0 0 -3 -3.85" />
                   ...
                   <!--  <li class="nav-item dropdown {{ request()->is('suppliers*', 'customers*') ? 'active' : null }}">
                    ...
                    @elseif($user->role === Role::SuperAdmin)
  ...
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M5 19h14a2 2 0 0 0 2 -2v-8a2 2 0 0 0 -2 -2h-7l-2 -2h-5a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2z" />
  <path d="M10 5v2a2 2 0 0 0 2 2h8" />
</svg>
  ...
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M4 7v-2a2 2 0 0 1 2 -2h2" />
  <path d="M16 3h2a2 2 0 0 1 2 2v2" />
  <path d="M20 17v2a2 2 0 0 1 -2 2h-2" />
  <path d="M8 21h-2a2 2 0 0 1 -2 -2v-2" />
  <path d="M8 14v.01" />
  <path d="M12 8v.01" />
  <path d="M16 12v.01" />
</svg>
