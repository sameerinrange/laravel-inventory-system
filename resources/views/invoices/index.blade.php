        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of {{ $customer->name }}<br/>Total Amount {{ auth()->user()->currency_code }}({{ auth()->user()->currency_symbol }}) {{ Cart::total() }}</h3>
                </div>
